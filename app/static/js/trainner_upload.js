        ...
        function setState( val ) {
            ...
            switch ( state ) {
                ...
                case 'ready':
                    ...
                    $( '#trainner_filePicker2' ).removeClass( 'element-invisible');
                    $queue.show();
                ...
                case 'uploading':
                    $( '#trainner_filePicker2' ).addClass( 'element-invisible' );
                    $progress.show();
                    $upload.text( '暂停上传' );
                    break;
